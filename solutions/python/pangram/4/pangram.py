...
def is_pangram(sentence):
    """Function checks if all letters in alphabet are within a sentence (string)
    creates a string of alphabet letters 

    lowers the sentence to one case 
    uses a if all function check to ensure all letters are present

    returns False or True for inputed string to pangram
    """
